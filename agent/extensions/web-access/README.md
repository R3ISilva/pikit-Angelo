...
- **Web search**: Queries Gemini AI with Google Search grounding — returns a synthesized answer with source citations
...
└── src/
    ...
    ├── search.ts    — web_search via Gemini API with google_search grounding
